...
//    }
    ...
    public T createNewInstance() {
        return (T) (resourceEntries ? /*new ResourceEntry(String.valueOf(database.size()))*/ null : new Entry(String.valueOf(database.size())));
    }
    ...
    private T toEntry(EntryData entryData) {
        return (T) (resourceEntries ? /*entryData.copy(ResourceEntry.class)*/ null : entryData.copy(Entry.class));
    }
